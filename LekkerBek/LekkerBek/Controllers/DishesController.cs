    ...
    public class DishesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Dish != null ? 
                          ...
                          Problem("Entity set 'LekkerBekContext.Dish'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Quantity")] Dish dish)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,Quantity")] Dish dish)
        {
            if (id != dish.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LekkerBekContext.Dish'  is null.");
            }
            var dish = await _context.Dish.FindAsync(id);
            if (dish != null)
            {
